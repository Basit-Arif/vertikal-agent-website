...
# DEFAULT_DB_URI intentionally removed for production-hardening. Use DATABASE_URL.

DATABASE_URL = os.environ.get("DATABASE_URL")
if not DATABASE_URL:
    raise RuntimeError(
        "DATABASE_URL environment variable is required. "
        "Set it via docker-compose or your deployment environment."
    )
...
class Config:
    ...
    # Strict: require DATABASE_URL from the environment (compose, k8s, etc.)
